...
import { pageMetadata, landingJsonLd } from "@/lib/seo";
import { cn } from "@/lib/utils";

export const metadata: Metadata = {
  ...pageMetadata({
    title: `${site.name} — Shipping Calculation API for India`,
    description: site.description,
    path: "/",
    keywords: [
      "shipping rate calculator India",
      "pincode to pincode shipping charges",
      "shipping charges between pincodes",
      "real-time shipping rates API",
      "checkout shipping estimate API",
      "shipping API for ecommerce India",
    ],
  }),
  // Homepage keeps the absolute title (no "· Postpin" template suffix).
  title: { absolute: `${site.name} — Shipping Calculation API for India` },
};
