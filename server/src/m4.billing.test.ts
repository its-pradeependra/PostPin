...
async function seed() {
  ...
  await PlanModel.create({ code: "growth", name: "Growth", description: "For scaling", priceMonthlyPaise: 499_900, priceYearlyPaise: 416_500, includedCalls: 250_000, maxApiKeys: 10, maxTeamMembers: 10, sortOrder: 2, ...common });
}
